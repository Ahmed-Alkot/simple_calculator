...
b_2 = Button(root, text=2, fg='white', bg='black', width = 7,
             height = 4, command= lambda: ins_num(2) )
b_3 = Button(root, text=3, fg='white', bg='black', width = 7,
             height = 4, command= lambda: ins_num(3))
b_4 = Button(root, text=4, fg='white', bg='black', width = 7,
             height = 4, command= lambda: ins_num(4) )
b_5 = Button(root, text=5, fg='white', bg='black', width = 7,
             height = 4, command= lambda: ins_num(5) )
b_6 = Button(root, text=6, fg='white', bg='black', width = 7,
             height = 4, command= lambda: ins_num(6) )
b_7 = Button(root, text=7, fg='white', bg='black', width = 7,
             height = 4, command= lambda: ins_num(7) )
b_8 = Button(root, text=8, fg='white', bg='black', width = 7,
             height = 4, command= lambda: ins_num(8) )
b_9 = Button(root, text=9, fg='white', bg='black', width = 7,
             height = 4, command= lambda: ins_num(9) )
b_0 = Button(root, text=0, fg='white', bg='black', width = 7,
             height = 4, command= lambda: ins_num(0) )
b_dot = Button(root, text='.',fg='black', bg='light green', width = 7,
               height = 4, command= lambda: ins_num('.') )
b_clear = Button(root, text='clear',fg='black', bg='orange', width = 7,
                 height = 4,command = clear )
b_equal = Button(root, text='=',fg='black', bg='orange', width = 7,
                 height = 4, command =evaluate)
b_add = Button(root, text = '+',fg='black', bg='light green', width = 7,
               height = 4, command= lambda: ins_num('+'))
b_sub = Button(root, text = '-', fg='black', bg='light green',width = 7,
               height = 4, command= lambda: ins_num("-"))
b_mult = Button(root, text = 'x',fg='black', bg='light green', width = 7,
                height = 4, command= lambda: ins_num('*') )

b_division = Button(root, text = '/',fg='black', bg='light green', width = 7,
                    height = 4, command= lambda: ins_num('/') )
b_power = Button(root, text = '^',fg='black', bg='light green', width = 7,
                 height = 4, command= lambda: ins_num('**') )
b_rpar = Button(root, text = '(',fg='black', bg='light green', width = 7,
                height = 4, command= lambda: ins_num('(') )
...
b_log = Button(root, text = 'log',fg='black', bg='light green', width = 7,
               height = 4, command= lambda: ins_num('math.log(') )
b_ln = Button(root, text = 'ln',fg='black', bg='light green', width = 7,
              height = 4, command= lambda: ins_num('math.log(') )
